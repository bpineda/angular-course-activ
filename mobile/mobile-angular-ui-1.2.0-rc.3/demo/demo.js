...
app.controller('MainController', function($rootScope, $scope){
  ...
  $scope.chatUsers = [
    ...
    { name: 'Fannie  Carlson', online: false },
    { name: 'Holly Nguyen', online: false },
    { name: 'Bill  Chavez', online: false },
    { name: 'Veronica  Maxwell', online: false },
    { name: 'Jessica Webster', online: false },
    { name: 'Jackie  Barton', online: false },
  ...
  $scope.email = 'correo@ejemplo.com';
